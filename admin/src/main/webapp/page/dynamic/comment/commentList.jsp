					...
					<table class="layui-table">
						...
						<tbody>
							<c:if test="${page.totalCount == 0}">
								<tr>
									<td colspan="4"><div class="f16 tc">还没有人评论</div></td>
								</tr>
							</c:if>
							<c:forEach var="comment" items="${comments}">
								<tr>
									...
									<td>
										<a href="javascript:openDialog('编辑评论','${ctx}/dynamic/comment/commentForm.do?id=${comment.id}','400px','300px')"><i class="iconfont icon-edit btn-icon"></i> 编辑</a>
										<a href="javascript:deleteObj('确定要删除吗？','${ctx}/dynamic/comment/delete.do?id=${comment.id}','');">

			...
			<form id="infoForm" class="layui-form mt20" method="post" action="${ctx}/gatherInfo/member/saveMember.do">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input class="layui-input" name="realname" lay-verify="realname" placeholder="真实姓名" id="realName" />
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						...
						<c:if test="${not empty project.id && empty group.id}">
							<a href="${ctx}/gatherInfo/member/list.do?projectId=${project.id}" class="layui-btn layui-btn-primary">取消</a>
						</c:if>
						<c:if test="${not empty group.id}">
							<a href="${ctx}/gatherInfo/member/list.do?pGroupId=${groupId.id}" class="layui-btn layui-btn-primary">取消</a>
						</c:if>
					</div>
				</div>
			</form>

				...
				<div class="act-detail-head mt20">
					...
					<div class="content-text">
						...
						<p class="f16 text-element">
							...
							<strong class="active-red">${newPrice}</strong>
						</p>
						<p class="f16 text-element">
							<i class="iconfont icon-people btn-icon"></i> 限制人数：
							<c:if test="${activity.limitNum == 0}">
								<strong class="active-red">不限</strong>
							</c:if>
							<c:if test="${activity.limitNum > 0}">
								<strong class="active-red">${activity.limitNum}</strong>人
							</c:if>
							报名人数：<strong class="active-red">${activity.joinNum}</strong>人
						</p>
						<p class="f16 text-element">

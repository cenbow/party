			...
			<div class="section-main">
				...
				<div class="act-detail-head mt20">
				    ...
				    <div class="content-text">
				        ...
				        <p class="f16 text-element">
				            <i class="iconfont icon-moneybag btn-icon"></i> 报名费用：<strong class="active-red"><fmt:formatNumber value="${activity.price}"></fmt:formatNumber></strong>&nbsp;元
				        </p>
				        <p class="f16 text-element">
				            <i class="iconfont icon-people btn-icon"></i> 报名人数：<strong class="active-red">${activity.joinNum}</strong>&nbsp;人
				            <i class="iconfont icon-people btn-icon  ml-30"></i> 众筹成功：<strong class="active-red">${activity.crowdfundedNum}</strong>&nbsp;人
				        </p>
				        <p class="f16 text-element">
				            <i class="iconfont icon-people btn-icon"></i> 支持人数：<strong class="active-red">${activity.favorerNum}</strong>&nbsp;人
				            <i class="iconfont icon-moneybag btn-icon ml-30"></i> 已筹金额：<strong class="active-red">${actualAmount}</strong>&nbsp;元
				        </p>
				    </div>
				</div>

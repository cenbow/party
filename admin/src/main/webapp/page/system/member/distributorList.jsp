	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				<div class="r">
					<a href="${ctx}/system/member/distributorForm.do" class="layui-btn layui-btn-radius layui-btn-danger">
						<i class="iconfont icon-add btn-icon"></i>添加分销商
					</a>
				</div>
				<div class="ovh">
					<span class="title f20">分销商管理</span>
					<span class="f12">共<b>${page.totalCount}</b>条记录</span>
				</div>
			</div>
			<form class="layui-form" action="${ctx}/system/member/distributorList.do" id="myForm" method="post">
						...
						<tbody>
							<c:forEach var="member" items="${members}">
								<tr>
									...
									<td  class="tb-opts">
										<div class="comm-opts">
											<a href="${ctx}/system/member/distributorForm.do?id=${member.id}" target="_self">
												编辑
											</a>
...
<!-- 											</a> -->
											...
											<a target="_self" href="javascript:openDialog('分配角色','${ctx}/system/role/distributionRole.do?memberId=${member.id}','400px','300px')">
												分配角色
											</a>
											<c:choose>
												<c:when test="${member.userStatus == 1 }">

    ...
    <section>
        <div class="section-main">
            ...
            <form id="myForm" class="layui-form mt20" method="post" action="${ctx}/sign/project/save.do">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">成绩审核</label>
                    <div class="layui-input-block">
                        <input type="radio" name="gradeCheck" lay-filter="gradeCheck" id="isApplyCheck" value="1" title="审核"
                        ${signProject.gradeCheck ==1 ? 'checked="checked"' : ''}>
                        <input type="radio" name="gradeCheck" lay-filter="gradeCheck" id="noApplyCheck" value="0" title="不审核"
                        ${signProject.gradeCheck ==0 ? 'checked="checked"' : ''}>
                    </div>
                </div>

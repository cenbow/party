    ...
    <section>
        <div class="section-main">
            <div class="c-time-list-header">
                ...
                <div class="ovh">
                    <span class="title f18"><a href="${ctx}/circle/list.do" class="">圈子管理</a></span>
                    ...
                    <table class="layui-table">
                        ...
                        <c:forEach var="circle" items="${list}">
                            <tr>
                                ...
                                <td>
                                    <div><fmt:formatDate value="${circle.update_date}" pattern="yyyy-MM-dd HH:mm"/></div>
                                </td>
                                    <%--<td>--%>
...
<div class="out-fix-opts">
    <ul class="options-content">
        <li><a target="_self" class="" href="/admin/circle/apply/list.do?circle=8be8f5e96e554cb29d369e9178b85dc7">
            会员审核
        </a></li>
        <li><a target="_self" class="" href="/admin/circle/topic/list.do?circle=8be8f5e96e554cb29d369e9178b85dc7">
            话题管理
        </a></li>
        <li><a target="_self" class="" href="/admin/circle/tag/list.do?circle=8be8f5e96e554cb29d369e9178b85dc7">
            用户类型管理
        </a></li>
        <li><a target="_self" class="" href="/admin/circle/topicTag/list.do?circle=8be8f5e96e554cb29d369e9178b85dc7">
            话题类型管理
        </a></li>
        <li><a target="_self" class="green" href="/admin/circle/form.do?id=8be8f5e96e554cb29d369e9178b85dc7">
            编辑
        </a></li>
        <li><a target="_self" class="red" href="javascript:delCircle('8be8f5e96e554cb29d369e9178b85dc7')">
            删除
        </a></li>
    </ul>
</div>

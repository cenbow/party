...
<meta name="keywords" content="深圳前海同行者咨询有限公司,同行者,CEO户外,活动,创业者,活动报名">
...
<script type="text/javascript" charset="utf-8" src="${ctxStatic}/ZeroClipboard/ZeroClipboard.min.js"></script>
...
<script>
	$(function(){
        ...
        $('.z-copy-btn').each(function (i) {
            clipboard(this, this.dataset.id, this.dataset.msg);
        })
	})
    /**
     *  复制到剪贴板
     ...
     * @returns {boolean}
     */
    function clipboard(btnO,text,msg) {
        if (window.clipboardData) {    //for ie
            ...
            var client = new ZeroClipboard($(btnO));

	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				...
				<div class="ovh">
					<span class="title f20">专题管理 &gt; ${subject.name}</span>
				</div>
			</div>
			<div style="padding-top: 20px;">
				<div class="content-left l">
						...
						<c:forEach var="apply" items="${applies}">
							<li>
								...
								<div class="r opts-btn" style="display: none;">
									<a href="${ctx}/subject/apply/applyForm.do?id=${apply.id}&subjectId=${subject.id}"><i class="iconfont icon-edit btn-icon"></i></a> <a
					...
					<div>
						<a href="${ctx}/subject/apply/applyForm.do?subjectId=${subject.id}" class="layui-btn layui-btn-radius layui-btn-danger layui-btn-small">
...
<tr>
	...
	<td>{{ getDateStr(item.createDate).Format('yyyy-MM-dd hh:mm') }}</td>
	<td>
		<a href="${ctx}/article/article/articleForm.do?id={{ item.id }}&subjectId=${subject.id}&applyId={{ item.applyId }}"><i class="iconfont icon-edit btn-icon"></i></a>
		...
		<div class="f-def-dialog">
			...
			<div class="f-dialog-content">
				...
				<div class="dialog-detail">
					...
					<div>
						<a class="download-qrcode" href="javascript:download('${ctx}','{{item.qrCodeUrl }}')">下载二维码</a>
					</div>
				</div>
			</div>
		</div>

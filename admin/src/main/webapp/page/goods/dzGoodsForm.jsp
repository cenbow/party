	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				...
				<div class="ovh">
					<span class="title f20">定制玩法管理&nbsp;&gt;&nbsp;${goods == null ? '发布' : '编辑'}定制玩法</span>
				</div>
			</div>
			<!-- 正文请写在这里 -->
			<form id="myForm" class="layui-form mt20" method="post" action="${ctx}/goods/goods/save.do">
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<select name="cityId" lay-verify="city">
						...
						<div class="layui-input-inline">
							<input type="text" id="area" name="area" lay-verify="area" placeholder="区域" class="layui-input" value="${goods.area}" />
						</div>
						<div class="layui-input-inline">
							<input type="text" id="place" name="place" lay-verify="place" placeholder="集合地点" value="${goods.place}" class="layui-input"
								style="width: 400px;"
							/> <input type="hidden" name="lat" id="lat" lay-verify="lat" value="${goods.lat}" /> <input type="hidden" name="lng" id="lng"
								value="${goods.lng}"
							/>
						</div>
					</div>
				...
				<!-- 						<div class="layui-input-inline"> -->
				<%-- 							<input class="layui-input" name="lng" lay-verify="lng" value='${goods.lng}'/> --%>
				<!-- 						</div> -->
				<!-- 					</div> -->
				<!-- 				</div> -->
				<!-- 				<div class="layui-form-item"> -->
				...
				<!-- 						<div class="layui-input-inline"> -->
				<%-- 							<input class="layui-input" name="lat" lay-verify="lat" value='${goods.lat}'/> --%>
				<!-- 						</div> -->
				<!-- 					</div> -->
				<!-- 				</div> -->
				...
				<div class="layui-form-item">
					<div class="layui-inline">
						<label class="layui-form-label">最少人数<span class="f-verify-red">*</span></label>
						<div class="layui-input-inline">
							<input type="text" name="minnum" lay-verify="minnum" class="layui-input" value="${goods.minnum}" placeholder="">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-inline">
						<label class="layui-form-label">最多人数<span class="f-verify-red">*</span></label>
						<div class="layui-input-inline">
							<input type="text" name="maxnum" lay-verify="maxnum" class="layui-input" value="${goods.maxnum}" placeholder="">
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						...
						<a href="${ctx}/goods/goods/dzGoodsList.do" class="layui-btn layui-btn-primary">取消</a>
					</div>
				</div>
			</form>
		</div>
                ...
                $.post(action, $('#myForm').serialize(), function(res) {
                    if (res.success) {
                        top.layer.msg('提交成功', {icon : 1}, function(index){
                            location.href = "${ctx}/goods/goods/dzGoodsList.do";
                        });
                    } else {

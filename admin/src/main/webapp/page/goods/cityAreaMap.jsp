...
<style type="text/css">
/**地图列表**/
.field_list_wrap_big{width:260px; position: absolute;left: 540px; text-align: left;}
.field_list_wrap{float: right; width: 240px; border: 1px solid #cacaca;}
.field_list_wrap .top{ height: 35px; overflow:hidden; line-height: 40px; padding-left: 10px; font-size: 14px; color: #444; background: url('${ctx}/image/activity/field_IconSprite5.png');}
.field_list_wrap .field_box{ height: 467px; overflow-y: auto; background: url('${ctx}/image/activity/field_IconSprite5.png');}
...
.field_list_wrap .field_li .number{ position: absolute; top: 8px; left: 10px; width: 17px; height: 24px; line-height: 20px; text-align: center; font-size: 12px; color: #fff; background: url('${ctx}/image/activity/address_bg.png') no-repeat;}
...
.field_list_wrap_big .close{ position: absolute; top: 0; width: 17px; height: 62px; border: 1px solid #cacaca; border-right:none; margin-top:210px; background: url('${ctx}/image/activity/field_IconSprite5.png');border-radius: 2px 0 0 2px; cursor: pointer;}
.field_list_wrap_big .close span{ width: 7px; height: 11px; background: url('${ctx}/image/activity/field_IconSprite4.png') no-repeat 0px 0; margin: 25px 5px; display: inline-block;}
.post_map {width:800px;height:512px;float:left;}
.activity-location .address-name{font-weight: normal;font-size: 16px; color: #000;}
.activity-location .set-address{color: red}
.activity-location a:hover{color: red}
.activity-location table td{padding-top: 10px;}
.post_site_K {width: 350px;height: 36px;border: 1px solid #d9d9d9;float: left;}
.post_site_K input {width: 250px;height: 100%;line-height: 100%;border: none;font-size: 14px;color: #444;float: left;margin: 8px 0 0 15px;margin-top: 0px;}
.post_site_K span {display: block;cursor: pointer;width: 72px;height: 20px;line-height: 19px;font-size: 14px;color: #666;text-align: right;border-left: 1px solid #d9d9d9;float: left;
	margin-top: 8px;background: url(http://cdn.hudongba.com/static_v4/images/detail/address_icon3.png) no-repeat 10px 1px;}
</style>
<!-- 城市_区域_地图 -->

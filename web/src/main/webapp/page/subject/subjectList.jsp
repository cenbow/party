	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				<div class="r">
					<a href="${ctx}/subject/subject/publishSubject.do" class="layui-btn layui-btn-radius layui-btn-danger"> <i
						class="iconfont icon-add btn-icon"></i> 发布专题
					</a>
				</div>
				<div class="ovh">
					<span class="title f20">我发布的专题</span>
				</div>
			</div>
						...
						<li>
							<div class="detail-content">
								...
								<div class="detail">
									...
									<div class="">
										<p class="act-price">
											栏目数量：<b class='active-red'>${fn:length(subject.subjectApplies)}</b>
										</p>
									...
									<div class="opts-btns tb-opts" style="width:475px;">
										<div class="comm-opts">
											...
											<a href="${ctx}/subject/subject/publishSubject.do?id=${subject.id }" target="_self"><i class="iconfont icon-edit btn-icon"></i> 编辑</a><span>|</span>
											...
											<a href="${ctx}/subject/apply/applyList.do?subjectId=${subject.id }" target="_self"> <i class="iconfont icon-peoplelist btn-icon"></i> 栏目管理</a>
										</div>
									</div>
								</div>
							</div>
							<div class="f-def-dialog qrCodeDialog">
								...
								<div class="f-dialog-content">
									...
									<div class="dialog-detail">
										...
										<img class="download-img" src="${qr_code}/${subject.qrCodeMap.qrCode }" />
										<div>
											<a class="download-qrcode" href="javascript:download('${ctx}','${subject.qrCodeMap.qrCode}')">下载二维码</a>
										</div>
										<div>
											<a class="download-qrcode looklink" href="javascript:lookLink('${ctx}','${subject.qrCodeMap.qrCodeContent}', '查看二维码链接')">查看链接</a>
										</div>
									</div>
								</div>
							</div>

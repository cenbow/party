		...
		<section>
			<div class="section-main">
				<div class="c-time-list-header">
					...
					<div class="ovh">
						<span class="title f20">我发布的专题 &gt; 专题详情</span>
					</div>
				</div>
				<div class="act-detail-head mt20">
					<div class="act-detail-content">
						<div class="detail-logo" style="background-image: url('${subject.picture}'),url(${ctx}/image/img_bg.png)"></div>
					</div>
				...
				<div class="detail-head mt20">
					<span class="head-title f20">栏目列表<span id="articleTotal" class="pl5"></span></span>
				</div>

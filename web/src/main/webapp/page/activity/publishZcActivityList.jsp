	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				<div class="r">
					<a href="${ctx}/activity/activity/publishZcAct.do" class="layui-btn layui-btn-radius layui-btn-danger"> <i
						class="iconfont icon-add btn-icon"></i>发布众筹项目
					</a>
				</div>
				<div class="ovh">
					<span class="title f20">众筹项目管理</span>
				</div>
			</div>
			...
			<div class="c-time-list-content">
				<ul>
					<c:if test="${page.totalCount == 0}">
						<div class="f16 tc mt15">还没有数据，请点击右上角的“发布众筹项目”，发布和编辑内容</div>
					</c:if>
...
<%-- 											</c:when> --%>
<%-- 										</c:choose> --%>
										<a title="${activity.title}" href="${ctx}/activity/activity/zcActivityDetail.do?actId=${activity.id}" target="_self"
											class="title f18 ell db">${activity.title}</a>
									</div>
									<div>
										<p class="act-price">
											截止时间：
										...
										<p class="act-price">
											发布时间：
											<fmt:formatDate value="${activity.createDate}" pattern="yyyy-MM-dd HH:mm" />
										</p>
									</div>
									<div class="opts-btns tb-opts"  style="width:475px;">
										<div class="comm-opts">
											...
											<a href="${ctx}/activity/activity/publishZcAct.do?id=${activity.id}"> <i class="iconfont icon-edit btn-icon"></i>
												编辑
											</a>
											...
											<shiro:hasPermission name="crowdfund:event:analyze">
							...
							<div class="f-def-dialog qrCodeDialog">
									...
									<div class="dialog-detail">
										...
										<div style="width: 320px; margin: 0px auto; margin-top: 10px">
											...
											<div class="l">
												...
												<img class="download-img" src="${qr_code}/${activity.qrCodeMap.dyQrCode }" />
												<div>
													<a class="download-qrcode" href="javascript:download('${ctx}','${activity.qrCodeMap.dyQrCode}')">下载二维码</a>
												</div>
												<div>
													<a class="download-qrcode looklink" href="javascript:lookLink('${ctx}','${activity.qrCodeMap.dyQrCodeContent}', '查看代言二维码链接')">查看代言链接</a>
												</div>
											</div>
											<div class="cl"></div>
										</div>
...
<script type="text/javascript">
	...
	// 二维码弹窗显示/隐藏
	qrCodeDialog('.c-time-list-content', 'qr-btn', '.detail-content', '.qrCodeDialog');

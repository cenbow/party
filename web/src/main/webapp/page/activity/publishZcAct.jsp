	...
	<section>
		<div class="section-main">
			<div class="c-time-list-header">
				<div class="r">
					<a href="${ctx}/activity/activity/zcActivityList.do" class="layui-btn layui-btn-radius layui-btn-danger"> <i
						class="iconfont icon-refresh btn-icon"></i>返回
					</a>
				</div>
				<div class="ovh">
					<span class="title f20">我发布的众筹项目&nbsp;&gt;&nbsp;${activity == null ? '发布' : '编辑'}众筹项目</span>
				</div>
			</div>
			<!-- 正文请写在这里 -->
			<form id="myForm" class="layui-form mt20" method="post" action="${ctx}/activity/activity/save.do">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="title" lay-verify="title" style="width: 80%" autocomplete="off" placeholder="活动标题"
					...
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" name="price" lay-verify="price" placeholder="￥" class="layui-input" value="${activity.price}"
								${activity != null ? ' readonly="readonly"' : ''} />
						</div>
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="crowdDeclaration" lay-verify="crowd_xy" style="width: 94%" autocomplete="off"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="supportDeclaration" lay-verify="support_xy" style="width: 94%" autocomplete="off"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="representDeclaration" lay-verify="represent_xy" style="width: 94%" autocomplete="off"
							placeholder="代言宣言" class="layui-input" value="${activity.representDeclaration}">
					</div>
				</div>
				<div class="layui-form-item">

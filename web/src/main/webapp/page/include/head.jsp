...
<script async src="${ctxStatic}/jquery/jquery-migrate-1.1.1.min.js" type="text/javascript"></script>
<script async type="text/javascript" src="${ctxStatic}/TableDnD/jquery.tablednd.js"></script>
...
<script async src="${ctxStatic}/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
<script async src="${ctxStatic}/pace/pace.min.js"></script>
...
<script async src="${ctxStatic}/dataTables/dataTables.bootstrap.js"></script>
...
<!-- jquery ui -->
<script async src="${ctxStatic}/jquery-ui/jquery-ui.min.js"></script>
...
<link href="${ctxStatic}/layui-v1.0.7/css/layui.css" type="text/css" rel="stylesheet" />
<script  src="${ctxStatic}/layui-v1.0.7/layui.js"></script>
<!--引入webuploader-->
<link rel="stylesheet" type="text/css" href="${ctxStatic}/webuploader-0.1.5/webuploader.css">
<script async type="text/javascript" src="${ctxStatic}/webuploader-0.1.5/webuploader.js"></script>
...
<script src="${ctxStatic}/common/util.js"></script> 

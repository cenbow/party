    ...
    <section>
        <div class="section-main">
            <div class="c-time-list-header">
                ...
                <div class="ovh">
                    <span class="title f20"><a href="${ctx}/circle/list.do" class="">我创建的圈子</a> > ${circle.id == null ? '添加' : '编辑'}圈子</span>
                </div>
            ...
            <form id="myForm" class="layui-form mt20" method="post" action="${ctx}/circle/save.do">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="cover-content">
                        ...
                        <div class="form-word-aux">建议尺寸：800*600</div>
                    </div>
                </div>
                ...
                <input type="hidden" name="showFront" value="0">
           <%--     <div class="layui-form-item">
                    <div class="layui-inline">

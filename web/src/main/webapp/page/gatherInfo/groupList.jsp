...
<div class="index-outside">
    ...
    <section>
        <div class="section-main">
            ...
            <form class="layui-form" action="${ctx}/gatherInfo/group/list.do?projectId=${project.id}" id="myForm" method="post">
            	...
            	<ul class="num">
					<div class="r">
						<li style="cursor: pointer;" class="r">
							<a class="layui-btn layui-btn-danger layui-btn-small" href="${ctx}/gatherInfo/group/toForm.do?projectId=${project.id}">创建小组</a>
						</li>
					</div>
					<p class="cl"></p>
				</ul>
	                        ...
	                        <c:forEach var="group" items="${groups}">
	                            <tr class="detail-content1">
	                                ...
	                                <td class="opts-btns tb-opts" style="width:350px">
	                                    <div class="comm-opts">
	                                        <a href="${ctx}/gatherInfo/member/list.do?pGroupId=${group.id}">人员管理</a>
	                                        <a class="green" href="${ctx}/gatherInfo/group/toForm.do?id=${group.id}&projectId=${project.id}">编辑</a>
	                                        <a class="red" href="javascript:deleteObj('确定要删除吗？','${ctx}/gatherInfo/group/delete.do?id=${group.id}','该分组下已有人员，不能删除','#myForm');">删除</a>
	                                    </div>
	                                </td>
	                            </tr>
	                        </c:forEach>

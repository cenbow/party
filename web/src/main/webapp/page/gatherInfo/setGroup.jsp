...
<div class="tag-wrap">
    ...
    <c:if test="${groups== null || fn:length(groups) == 0}">
        <div class="tc">
            ...
            <div onclick="javascript:parent.window.location.href='${ctx}/gatherInfo/group/list.do?projectId=${memberInfo.projectId}';" class="layui-btn layui-btn-radius layui-btn-danger">
...
<script type="text/javascript">
    ...
    function doSubmit() {
        ...
        var flag = false;
        $.ajax({
            url: '${ctx}/gatherInfo/group/saveMemberGroup.do',
            type: "POST",
            dataType: "JSON",
            async: false,
            data: {

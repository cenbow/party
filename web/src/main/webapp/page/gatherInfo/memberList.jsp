                        ...
                        <div class="cl">
                            <table class="layui-table">
                                ...
                                <c:forEach var="memberInfo" items="${memberInfos}">
                                    <tr>
                                        <td title="${memberInfo.groupName}">
                                            <div class="word-break">${empty memberInfo.groupName ? '未分配' : memberInfo.groupName}</div>
                                        </td>
                                        ...
                                        <td title="${memberInfo.fullname}">
                                            <div class="word-break">${memberInfo.fullname}</div>
                                        </td>
                                        <td><c:if test="${memberInfo.sex == 1}">男</c:if><c:if test="${memberInfo.sex == 0}">女</c:if></td>
                                        <td title="${memberInfo.company}">
                                            <div class="word-break">${memberInfo.company}</div>
                                        </td>
                                        <td title="${memberInfo.jobTitle}">
                                            <div class="word-break">${memberInfo.jobTitle}</div>
                                        </td>

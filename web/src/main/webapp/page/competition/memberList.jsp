                        ...
                        <div class="search-container">
                            ...
                            <ul class="search-form-content">
                                ...
                                <c:if test="${empty pGroupId}">
                                    <li class="form-item-inline"><label class="search-form-lable">组&emsp;名</label>
                                        <div class="layui-input-inline">
                                            <select name="groupId">
                                                <option value="">全部</option>
                            ...
                            <table class="layui-table">
                                ...
                                <c:forEach var="competitionMember" items="${competitionMembers}">
                                    <tr>
                                        ...
                                        <td title="${competitionMember.member.company}">
                                            <div class="word-break">${competitionMember.member.company}</div>
                                        </td>
                                        <td title="${competitionMember.member.jobTitle}">
                                            <div class="word-break">${competitionMember.member.jobTitle}</div>
                                        </td>

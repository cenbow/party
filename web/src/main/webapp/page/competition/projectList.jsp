    ...
    <section>
        <div class="section-main">
            <div class="c-time-list-header">
                ...
                <div class="ovh">
                    <span class="title f18"><a href="${ctx}/competition/project/list.do" class="">我发布的赛事项目</a></span>
                            ...
                            <tr class="detail-content1">
                                ...
                                <td class="opts-btns tb-opts">
                                    ...
                                    <div class="comm-opts">
                                        ...
                                        <a class="red" href="javascript:deleteObj('${ctx}/competition/project/delete.do?id=${project.id}','#myForm');">删除</a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>

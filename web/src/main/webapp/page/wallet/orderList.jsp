...
<div class="index-outside">
    ...
    <section>
        <div class="section-main">
            <%@include file="walletInfo.jsp" %>
            <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
                <ul class="layui-tab-title">
                    <li class="layui-this"><span class="title f20 ml5 mr5">明细记录</span></li>
                    <li><span class="title f20 ml5 mr5">提现记录</span></li>
                </ul>
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <form class="layui-form" action="${ctx}/wallet/orderList.do" id="myForm" method="post">

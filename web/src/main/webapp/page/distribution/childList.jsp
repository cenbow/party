                ...
                <div class="f-search-bar">
                    <div class="search-container">
                        <%-- <ul class="search-form-content">
                            <li class="form-item-inline"><label class="search-form-lable">分销商</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="distributorName" autocomplete="off" class="layui-input" value="${input.distributorName}" placeholder="请输入查询分销商">
                                </div>
                            </li>
                            <li class="form-item-inline"><label class="search-form-lable">项目名</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="title" autocomplete="off" class="layui-input" value="${input.title}" placeholder="请输入查询项目名">
                                </div>
                            </li>
                        </ul>
                        <ul class="search-form-content">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $('.applyNum').click(function () {
            ...
            window.location.href = '${ctx}/distribution/apply/listView.do?distributionId='+ id +"&hrefId="+id + "&targetId="+targetId;
        });

        $('.salesNum').click(function () {
            var id = this.dataset.id;
            var targetId = this.dataset.targetid;
            window.location.href = '${ctx}/distribution/order/listView.do?distributionId='+ id + "&hrefId="+id + "&targetId=" + targetId;
        });
    });
</script>
</body>

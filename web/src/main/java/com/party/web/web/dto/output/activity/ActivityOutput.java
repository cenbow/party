package com.party.web.web.dto.output.activity;
...
public class ActivityOutput {
	...
	private String detailQrCode; // 众筹项目详情二维码
	...
	public void setDetailQrCode(String detailQrCode) {
		this.detailQrCode = detailQrCode;
	}

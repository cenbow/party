...
public class QRCodeUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		String targetId = "2";
		String content = "http://3g.tongxingzhe.cn/micWeb/html/hd/hd_distribution.html?id=291b9bce1a614e5da12f03b19dcbdfbf&parentId=0&distributorId=71080f2503d44867ad1ec27f7487915a";
		String path = "D:/sdb1/test/";

		OutputStream output = new FileOutputStream(path + targetId + ".jpg");
